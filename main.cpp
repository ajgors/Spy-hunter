...
int main(int argc, char* argv[])
{
	...
	{
		std::cout << "SDL nie zosta≥o zainicjalizowane. B≥πd: " << SDL_GetError() << std::endl;
		return EXIT_FAILURE;
	}
	...
	if (window == nullptr)
	{
		std::cout << "Okno nie zosta≥o utworzone. B≥πd: " << SDL_GetError() << std::endl;
		SDL_Quit();
		return EXIT_FAILURE;
	}
	...
	if (renderer == nullptr)
	{
		std::cout << "Renderer nie zosta≥ utworzony. B≥πd: " << SDL_GetError() << std::endl;
	...
	{
		std::cout << "Nie uda≥o siÍ wczytaÊ grafiki samochodu. B≥πd: " << SDL_GetError() << std::endl;
	...
	{
		std::cout << "Nie uda≥o siÍ utworzyÊ tekstury samochodu. B≥πd: " << SDL_GetError() << std::endl;
		SDL_DestroyRenderer(renderer);
		SDL_DestroyWindow(window);
		SDL_Quit();
		return EXIT_FAILURE;
	...
	{
		std::cout << "Nie uda≥o siÍ wczytaÊ grafiki drogi. B≥πd: " << SDL_GetError() << std::endl;
	...
	{
		std::cout << "Nie uda≥o siÍ utworzyÊ tekstury drogi. B≥πd: " << SDL_GetError() << std::endl;
		SDL_DestroyTexture(carTexture);
		SDL_DestroyRenderer(renderer);
		SDL_DestroyWindow(window);
		SDL_Quit();
